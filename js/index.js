...
function alertYes(){
    alert("Obrigada por prestar atenção na aula! Esse é o mínimo ☺")
}

//declarando variaveis para armazenar as posicoes no botão
var topMod = 0
var leftMod = 0
var mobileState = 0

//funcao que identifica qual dispositivo está sendo renderizado
...
function webHandler(event){
    ...
    //definindo uma área de respiro no nosso botao
    ...
    if(distance < 80){
        ...
        //modificando o a posicao pelo css do botao not
